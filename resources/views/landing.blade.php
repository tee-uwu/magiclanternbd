...
body:not([data-theme="dark"]) .section-dark .section-title { color: var(--text); }
body:not([data-theme="dark"]) .section-dark .section-sub { color: var(--muted); }
...
body:not([data-theme="dark"]) .section-dark table { color: var(--text) !important; }
body:not([data-theme="dark"]) .section-dark table td { border-bottom-color: rgba(15,185,247,0.12) !important; }
...
body:not([data-theme="dark"]) .section-dark .review-user span { color: var(--muted); }
...
.theme-toggle:hover { transform: translateY(-1px) !important; box-shadow: 0 16px 44px rgba(15,60,95,0.18) !important; }
.theme-toggle:active { transform: translateY(0) scale(0.98) !important; }

.theme-toggle .sun-icon,
.theme-toggle .moon-icon { font-size: 14px !important; opacity: .9 !important; transition: opacity .18s ease !important; }
